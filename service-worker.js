const CACHE_NAME = 'cache-v46'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v46',
    'estilos/styles.css?v46',
    'estilos/mediaQueries.css?v46',
    'javascript/script.js?v46',
